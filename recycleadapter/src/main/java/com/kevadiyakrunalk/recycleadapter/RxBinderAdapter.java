...
import com.kevadiyakrunalk.recycleadapter.swipmenu.Extension;
import com.kevadiyakrunalk.recycleadapter.swipmenu.ItemTouchHelperCallback;
import com.kevadiyakrunalk.recycleadapter.swipmenu.ItemTouchHelperExtension;
...
public class RxBinderAdapter extends RecyclerView.Adapter<RxBinderAdapter.ViewHolder>{
    private int variable;
    private List<Object> list;
    private Map<Class<?>, Integer> map;
    private PublishSubject<ViewHolder> mPublishSubject;
    ...
    public RxBinderAdapter(List<Object> list, int variable, Map<Class<?>, Integer> map,
    ...
    public rx.Observable<ViewHolder> asObservable() {
    ...
    public void updateDataSet(List<Object> dataSet) {
        list = dataSet;
    ...
    public static class Builder {
        ...
        public RxBinderAdapter build() {
            return new RxBinderAdapter(list, variable, map, handler, onBind,
