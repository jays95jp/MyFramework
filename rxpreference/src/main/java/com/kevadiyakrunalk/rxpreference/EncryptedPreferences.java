package com.kevadiyakrunalk.rxpreference;
...
public final class EncryptedPreferences {
	...
	public static EncryptedPreferences getInstance(Context context, String prefName, String password){
		if (encryptedPreferences == null) {
			encryptedPreferences = new EncryptedPreferences.Builder(context)
					.withPreferenceName(prefName)
					.withEncryptionPassword(password).build();
		}
		return encryptedPreferences;
	}
	...
	public Set<String> getStringSet(String keys, Set<String> set) {
		Set<String> decryptedKeySet = new HashSet<>();
		for(String key : sharedPreferences.getStringSet(keys, set)) {
			decryptedKeySet.add(decryptString(key));
		}
		return decryptedKeySet;
	}
	...
	public final class EncryptedEditor {
		...
		public EncryptedEditor putStringSet(String key, Set<String> value) {
			putValue(key, String.valueOf(value));
			return this;
		}
