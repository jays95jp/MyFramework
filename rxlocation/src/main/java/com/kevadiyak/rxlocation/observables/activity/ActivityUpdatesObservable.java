package com.kevadiyak.rxlocation.observables.activity;
...
/**
 * The type Activity updates observable.
 */
public class ActivityUpdatesObservable extends BaseActivityObservable<ActivityRecognitionResult> {
    private static final String ACTION_ACTIVITY_DETECTED = "com.mylibrary.ACTION_ACTIVITY_UPDATE_DETECTED";
     ...
     * @param detectionIntervalMiliseconds the detection interval miliseconds
     * @return the observable
     */
    public static Observable<ActivityRecognitionResult> createObservable(Context context, int detectionIntervalMiliseconds) {
        return Observable.create(new ActivityUpdatesObservable(context, detectionIntervalMiliseconds));
    }
    ...
    private static class ActivityUpdatesBroadcastReceiver extends BroadcastReceiver {
        ...
        /**
         * Instantiates a new Activity updates broadcast receiver.
         *
